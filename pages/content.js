...
import TeamBioCT from '../components/teamBioCT'
  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <Image src="/Content.png" height="213.6" width="753.6" alt="Content Team Banner. Black and white photo of a video editing timeline." />
